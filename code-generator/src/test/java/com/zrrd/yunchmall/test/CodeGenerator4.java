    ...
    public void generateCode() {
        ...
        FastAutoGenerator.create(url, username, password)
                ...
                .strategyConfig(builder -> {
                    builder.addInclude("sms_coupon","sms_coupon_history","sms_coupon_product_category_relation","sms_coupon_product_relation","sms_flash_promotion","sms_flash_promotion_log","sms_flash_promotion_product_relation","sms_flash_promotion_session","sms_home_advertise","sms_home_brand","sms_home_new_product","sms_home_recommend_product","sms_home_recommend_subject") // 设置需要生成的表名
